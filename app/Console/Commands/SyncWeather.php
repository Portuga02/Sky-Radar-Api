...
class SyncWeather extends Command
{
    ...
    protected $description = 'Sincroniza os dados de chuva reais com o satelite da Open-Meteo';

    public function handle(WeatherIntegrationService $weatherService)
    {
        $this->info('🛰️  Buscando dados no satelite...');

        $weatherService->syncRealTimeWeather();

        $this->info('✅ Base de dados atualizada com o clima real de Recife!');
    }
}
